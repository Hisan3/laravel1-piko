                            ...
                            <form class="middle-box">
                                ...
                                <div class="search-box">
                                    <div class="input-group">
                                        <input type="search" id="search_input" class="form-control" placeholder="What are you looking for?" value="{{ @$_GET['keyword'] }}">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        @auth('customer')
                                            ...
                                            <a href="{{ route('customer.profile') }}"><i title="Profile" class="fi flaticon-user-profile"></i></a></li>
                                            <a href="{{ route('customer.logout') }}"><span>Logout</span></a></li>

                                        @else
                                        <a href="{{ route('customer.login') }}"><i class="fi flaticon-user-profile"></i><span>Login</span></a></li>
                                        @endauth
                                    <li>
                                                ...
                                                <div class="mini-cart-items">
                                                    <div class="mini-cart-item clearfix">
                                                        ...
                                                        <div class="mini-cart-item-des">
                                                            ...
                                                            <span class="mini-cart-item-price">&#2547;{{ $cart->rel_to_inventory->where('product_id',$cart->product_id)->where('color_id',$cart->color_id)->where('size_id',$cart->size_id)->first()->after_discount }} X {{ $cart->quantity }}</span>
                                                            <span class="mini-cart-item-quantity"><a href="{{ route('cart.remove',$cart->id) }}"><i
                                                                        class="ti-close"></i></a></span>
                                                            <span><b>Color:</b>{{ $cart->rel_to_color->color_name }} , <b>Size:</b>{{ $cart->rel_to_size->size_name }} </span>
                                                        </div>
                                                        @php
                                                           $sub_total += $cart->rel_to_inventory->where('product_id',$cart->product_id)->where('color_id',$cart->color_id)->where('size_id',$cart->size_id)->first()->after_discount * $cart->quantity ;
                                                        @endphp
                                                        @empty
...
7                                                    @endforeach
                            ...
                            <div class="col-lg-2 col-md-1 col-1">
                                <div class="header-right">
                                    <a href="{{ route('recent.views') }}" class="recent-btn"><i class="fi flaticon-refresh"></i>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <img src="{{ asset('front') }}/images/logo-2.svg" alt="blog">
                                </div>
