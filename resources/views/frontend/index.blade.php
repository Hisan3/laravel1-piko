            ...
            <div class="container container-fluid-sm">
                <div class="hero-slider">
                    ...
                    <div class="hero-slider-item">
                        <div class="slider-bg">
                            <img src="{{ asset('uploads/banner') }}/{{ $banner->banner_img }}" alt="">
                        </div>
            ...
            <div class="container">
                ...
                <div class="featured-categorie-slider owl-carousel">
                    ...
                    <div class="featured-item">
                        <div class="images">
                            <img width="140" height="100" src="{{ asset('uploads/category') }}/{{  $category->category_image }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a title="{{ $category->category_name }}" href="product.html">{{Str::length( $category->category_name) > 12? Str::substr( $category->category_name, 0, 10).'...':  $category->category_name }}</a></h2>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div>
                            <div class="banner-two-wrap" style="background-image: url('{{ asset('uploads/offer/') }}/{{ $offer->offer_img }}')">
                                <div class="text">
                                    <h2>{{ $offer->title }}</h2>
            ...
            <div class="container">
                <div class="upcoming-offer">
                    ...
                    <div class="right-image">
                        <img src="{{ asset('front') }}/images/upcomming-right.png" alt="">
                    </div>
                        ...
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('front') }}/images/top-selling/1.png" alt="">
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('front') }}/images/top-selling/2.png" alt="">
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('front') }}/images/top-selling/3.png" alt="">
                                    </div>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img src="{{ asset('uploads/product/preview') }}/{{$recently_added->preview }}" alt="">
                                    </div>
                                </div>
                                <div class="content">
                                    <h3><a href="product.html">{{$recently_added->product_name }}</a></h3>
                                    <div class="rating-product">
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                    ...
                                    <div class="price">
                                        @if ($recently_added->discount)
                                        <span class="present-price">&#2547;{{ App\Models\Inventory::where('product_id',$recently_added->id)->first()->after_discount }}</span>
                                        <del class="old-price">&#2547;{{ App\Models\Inventory::where('product_id',$recently_added->id)->first()->price }}</del>
                                        @else
                                        <span class="present-price">&#2547;{{ App\Models\Inventory::where('product_id',$recently_added->id)->first()->price }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
