    ...
    <div class="page-wrapper">
        ...
        <div class="wpo-login-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="wpo-accountWrapper" action="{{ route('customerlogin') }}" method="POST">
                            @csrf
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="alert alert-danger">{{ session('not_verified') }} <a href="{{ route('mail.verify.req') }}">Didn't Get Verify Email??</a></div>
                                @endif
                                ...
                                <ul class="wpo-socialLoginBtn">
                                    <li><button class="bg-danger" tabindex="0" type="button"><span>
                                        <a href="{{ route('google.redirect') }}"><i class="ti-google"></i></a></span></button></li>
                                    <li>
                                        <button class="bg-secondary" tabindex="0" type="button"><span>
                                        <a href="{{ route('github.redirect') }}"><i class="ti-github"></i></a>
                                        </span></button>
                                    </li>
                                </ul>
