...
<div id="details" class="clearfix">
    ...
    <h2 class="name">{{ App\Models\Billing::where('order_id', $order_id)->first()->fname }} {{ App\Models\Billing::where('order_id', $order_id)->first()->lname }}</h2>
    <div class="address">{{ App\Models\Billing::where('order_id', $order_id)->first()->address }},{{ App\Models\Country::where('id', $country_id)->first()->country_id }},{{ App\Models\Billing::where('order_id', $order_id)->first()->zip }},{{ App\Models\City::where('id', $city_id)->first()->city_id }}</div>
